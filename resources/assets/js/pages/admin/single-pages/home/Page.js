...
class Page extends React.Component {
    ...
    onAvatarChange(type, e){
        ...
        Object.keys(files).map(function(key, index) {
            if (files[index].files && files[index].files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    var sub_key = temp[1];
                    Object.keys(services).map(function (key, i) {
                        if (temp[0] == key) {
        ...
        Object.keys(badge_files).map(function (key, index) {
            if (badge_files[index].files && badge_files[index].files[0]) {
                var reader = new FileReader();
                reader.onload = function(e) {
                    Object.keys(badges).map(function (key, i) {
                        if (key == type) {
        ...
        Object.keys(carousel_files).map(function (key, index) {
        ...
        Object.keys(news_files).map(function (key, index) {
    ...
    updateHeader() {
        ...
        Http.post('/api/admin/update-page', {name: 'home', data: JSON.stringify(header), type: 'header'}).then(
            res => {
    ...
    onUpdateService(e, type) {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'home', data: JSON.stringify(services), type: 'service', service_type: type}).then(
            res => {
                this.setState({ isLoaded: true });
            }
        ).catch(err => {
    ...
    onUpdateBadge(e, type) {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'home', data: JSON.stringify(badges), type: 'badge', service_type: type}).then(
            res => {
                this.setState({ isLoaded: true });
            }
        ).catch(err => {
    ...
    onUpdateCarousel (e, type) {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'home', data: JSON.stringify(carousels), type: 'carousel', service_type: type}).then(
            res => {
                this.setState({ isLoaded: true });
            }
        ).catch(err => {
    ...
    onUpdateNews (e, type) {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'home', data: JSON.stringify(news), type: 'news', service_type: type}).then(
            res => {
                this.setState({ isLoaded: true });
            }
        ).catch(err => {
